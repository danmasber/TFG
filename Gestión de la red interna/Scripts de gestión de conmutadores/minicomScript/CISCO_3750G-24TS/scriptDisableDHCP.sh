...
rm -f "${DIRECTORIO}MinicomScripts/scriptDisableDHCP.tmp"

minicom -d "$TTY_SERIAL" -b "${BAUD_RESCUE}" -S "${DIRECTORIO}MinicomScripts/scriptDisableDHCP" 
comprobarEjecucion $? "Al procesar ${DIRECTORIO}MinicomScripts/scriptDisableDHCP" 
