...
minicom -d "$TTY_SERIAL" -b "${BAUD_RESCUE}" -S "${DIRECTORIO}MinicomScripts/scriptEnableDHCP" 
comprobarEjecucion $? "Al procesar ${DIRECTORIO}MinicomScripts/scriptEnableDHCP" 
