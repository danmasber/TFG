...
"${DIRECTORIO}"ExpectScripts/enableDHCP.expect "$USUARIO_MANAGER" "$CONTRASENA_MANAGER" "$IP_SWITCH" "$PORT_SWITCH" 
comprobarEjecucion $? "Al procesar ${DIRECTORIO}ExpectScripts/enableDHCP.expect" 
